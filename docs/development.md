...
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ------------------- |
| RF-001 | A aplicação permite que novos usuários conheçam a Gerency e conheçam brevemente o sistema e o acessem atráves do botão de "Login".                                                                | Vitor/Ingrid    | index.html          |
...
| RF-015 | A aplicação valida se todos os campos obrigatórios estão preenchidos no modal de edição de lançamento.                                                                                            | Ingrid          | meta.html           |
